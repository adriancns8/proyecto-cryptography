...
# Importamos las funciones necesarios de la librería cryptography
from cryptography.fernet import Fernet

# Ahora definimos el título
st.title("Cifrado Adrián Cryptography - Codificación y Decodificación")

# Si la variable texto_cifrado no existe, la crea con un valor nulo
...
# Si está el archivo mostrará lo siguiente
if archivo:
    ...
    st.session_state.texto_cifrado = texto # En la variable texto_cifrado almacenamos el texto del archivo
...
# Creamos el fichero descifrado.txt y almacenamos el texto descifrado
